...
$('#accepnewId').click(function(){
    //alert('hi')
    $('#showcntDes').show();
});

$('.burgerMenu').click(function(){
$('.navlist').toggleClass('showhideMenu');
});

$('.fndTlntFndWrkDiv ul li').click(function(){
    $('.hidegig').hide();
    $('.fndTlntFndWrkDiv ul li').removeClass('activTlnt');
    var fndGigId = $(this).attr('rel');
    $('#'+fndGigId).show();
    $(this).addClass('activTlnt');
});

$('.basicTopTab ul li').click(function(){
    $('.phide').hide();
    $('.basicTopTab ul li').removeClass('actTb');
    var pId = $(this).attr('rel');
    $('#'+pId).show();
    $(this).addClass('actTb');
});

$('.loginDivTab ul li').click(function(){
    $('.hideLogin').hide();
    $('.loginDivTab ul li').removeClass('activeLgn');
    var lgnTlnkId = $(this).attr('rel');
    $('#'+lgnTlnkId).show();
    $(this).addClass('activeLgn');
});

$('.dashbrdTabDiv ul li').click(function(){
    $('.hideDashCnt').hide();
    $('.dashbrdTabDiv ul li').removeClass('dashTabActv');
    var tablnkId = $(this).attr('rel');
    $('#'+tablnkId).show();
    $(this).addClass('dashTabActv');
});


    $('.nmbrMbrLst li').click(function(){
        $('.nmbrMbrLst li').removeClass('MemberActLst');
        $(this).addClass('MemberActLst');
    });
    $('.bookDivOneIn').click(function(){
        $(this).toggleClass('activeBx')
    });
 $('.upcmngDivTab ul li').click(function(){
    $('.hideUpcmngTb').hide();
    $('.upcmngDivTab ul li').removeClass('activeMBkng');
    upcmngId = $(this).attr('rel');
    $('#'+upcmngId).show();
    $(this).addClass('activeMBkng');
 })
/* $( function() {
    $( "#datepicker" ).datepicker();
  } );*/
...
function get_data(val) {
        ...
        window.location.href='job-list.html?city='+val.value;
...
$(".skpTpcnt").click(function() {
     $('html, body').animate({
         scrollTop: $(".selectCatSec").offset().top
     }, 500);
 });
});
...
$(document).ready(function() {
  var resize = new Array('span', 'p', 'div', '.resizable');
  resize = resize.join(',');
